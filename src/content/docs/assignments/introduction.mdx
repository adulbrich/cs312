...
1. [Minecraft Ops 1: Manual EC2 Server (AWS Academy)](/assignments/minecraft-1-manual-configuration/)
2. [Minecraft Ops 2: Docker + ECR on EC2](/assignments/minecraft-2-docker/)
3. [Minecraft Ops 3: Terraform-Provisioned EC2 + Automated Deploy](/assignments/minecraft-3-terraform-compose/)
4. [Minecraft Ops 4: Kubernetes Migration (k3s on EC2)](/assignments/minecraft-4-k3s-migration/)
5. [Minecraft Ops 5: IaC + Multi-Node k3s + Observability](/assignments/minecraft-5-platform-observability/)
