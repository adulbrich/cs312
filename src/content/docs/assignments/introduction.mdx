...
Your PDF should be complete enough for a TA or operator to understand your system without private context. Across all five assignments, you will be evaluated on the same themes:

- **Architecture and decisions**: key choices and tradeoffs, with justification.
- **Runbooks**: how to deploy, validate, upgrade, rollback, and recover.
- **Evidence**: screenshots, logs, dashboard exports, or command output that proves requirements are met.
