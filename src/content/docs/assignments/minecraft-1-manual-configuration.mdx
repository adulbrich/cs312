---
title: 'Manual Minecraft Server on EC2'
...
What would break if you had to rebuild this server from scratch tomorrow? What information would you need that isn't in your runbook?
</Aside>
<Aside type="note" title="Question 2">
If two operators needed to manage this server simultaneously, what conflicts or risks would arise with your current setup?
</Aside>
## What You'll Submit
