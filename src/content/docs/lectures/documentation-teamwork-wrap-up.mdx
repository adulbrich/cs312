...
<Aside type="tip" title="Write It Down After the Second Time">
...
<Aside type="caution" title="Make Decisions Explicit">
...
<Aside type="note" title="Prefer Version-Controlled Diagrams">
...
<Aside type="tip" title="Review Documentation Like Code">
