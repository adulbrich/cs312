...
These references are useful if you want to see the same physical-infrastructure ideas from operator, vendor, and standards perspectives. They work best as follow-up reading after the lecture, because they assume you already have the vocabulary for racks, fabrics, power, and facility design.
