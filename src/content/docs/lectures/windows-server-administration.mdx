...
order: 18
covers: Windows Server 2025 context; AD DS identity model; Kerberos, LDAP, DNS; OUs, groups, Group Policy; SMB and NTFS; replication, backup, hybrid identity
prereq_lectures: postmortems-and-communications
followup_lectures: server-datacenter-architecture
