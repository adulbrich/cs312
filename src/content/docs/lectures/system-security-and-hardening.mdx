...
order: 19
covers: threat modeling and CIA triad; Linux hardening (SSH keys, least privilege, UFW, Fail2Ban, patching); container and image security; cloud IAM least privilege; IaC secrets management; CI/CD pipeline security; Kubernetes RBAC and NetworkPolicy; admission controllers; secrets encryption at rest; audit logging; security retrospective across all course topics
prereq_lectures: linux-server-planning-and-configuration, networking-fundamentals, containerization-with-docker, cloud-computing, infrastructure-as-code, configuration-management, ci-cd, container-orchestration, network-services-and-application-delivery, monitoring-and-performance, log-management-and-analysis, incident-response-fundamentals, site-reliability-and-capacity-planning, windows-server-and-active-directory, on-premises-infrastructure
