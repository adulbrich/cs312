...
For production environments, tools like [`AIDE`](https://aide.github.io/) (Advanced Intrusion Detection Environment) automate this across the entire filesystem with nightly checks and email reports.
...
On Debian and Ubuntu, the OpenSSH service unit is usually named `ssh`; on many Red Hat-family systems it is `sshd`.
