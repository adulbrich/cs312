...
{/* TODO: Reframe this lecture as a security retrospective across prior topics (Linux, networking, containers, cloud, IaC, configuration management, CI/CD) with a forward-look at cluster security concerns (RBAC, secrets, network policies) for Lab 7. Update title and description once the reframing is drafted. */}
