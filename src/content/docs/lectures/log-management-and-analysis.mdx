...
<Aside type="note">
Timestamps are the single most important field in any log entry. Without consistent, accurate timestamps, you cannot reconstruct a timeline. Make sure your servers synchronize time via NTP, and prefer timestamps that include the year and timezone (ISO 8601 format, such as `2026-03-15T03:04:12Z`).
</Aside>
