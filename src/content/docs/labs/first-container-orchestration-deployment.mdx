...
8. After applying the updated Secret and Deployment, what did `kubectl rollout status deployment/wordpress` report? How does a rolling update keep the site available during the update? *(3 points)*
