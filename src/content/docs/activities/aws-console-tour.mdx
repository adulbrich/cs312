...
{/* TODO: proper AWS CLI introduction + installation + grab AWS CLI info from learner lab */}
...
{/* TODO: fix this section as it is incorrect and most will be done in class - only the AWS CLI must be installed beforehand */}
...
{/* TODO: should be in the first part in class + AWS CLI info */}
