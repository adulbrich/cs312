...
4. **Write `terraform.tfvars`:**
   ...
   Replace `ulbrical` with your actual ONID. Terraform loads this file automatically; any variable declared in `variables.tf` without a default must appear here or be supplied another way.
