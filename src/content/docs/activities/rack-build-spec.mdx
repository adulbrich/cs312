...
{/* TODO: need to review activity to be much more prescriptive, i.e., choose a rack server vendor that has clear and easy to use spreadsheets, same for network vendor + recommend specific models to students and ask them to calculate - this will save a TON of time */}
...
<Steps>
1. **Open a vendor configurator.** The [Dell PowerEdge rack-server catalog](https://www.dell.com/en-us/shop/dell-poweredge-servers/sc/servers), [HPE rack-server catalog](https://buy.hpe.com/us/en/servers-systems), and [Supermicro system selector](https://www.supermicro.com/en/products/system) are the quickest starting points. Pick one vendor and stay with it for this activity.
