...
1. **Create a new public GitHub repository.** Go to [github.com/new](https://github.com/new), name it `cs312-ci-activity`, set visibility to **Public**, check **Add a README file**, and click **Create repository**.
