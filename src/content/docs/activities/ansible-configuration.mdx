...
3. **Run the linter against this first version:**
    ...
    ```
    A clean playbook produces no output. If you see warnings, fix them before continuing. You can run `ansible-lint site.yml --fix` to automatically apply some fixes.
