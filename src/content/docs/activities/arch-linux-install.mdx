...
<ActivityQuestion>
The lecture describes four boot stages: firmware, bootloader, kernel, systemd. Which specific steps in this activity correspond to each stage? (The firmware stage is handled by the VM; what did you configure in VirtualBox that relates to it?)
</ActivityQuestion>
