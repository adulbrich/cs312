...
<ActivityQuestion>
If your VM shows `10.0.2.15/24`, the network is `10.0.2.0/24`, the broadcast address is `10.0.2.255`, and there are 254 usable host addresses. What would the equivalent values be for a `/25` network?
</ActivityQuestion>
