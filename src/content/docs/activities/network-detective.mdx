...
- On the Arch VM:
   ...
   ```bash
   sudo pacman -S --needed iproute2 iputils curl traceroute bind nmap
   ```
...
4. Inspect the layer-2 neighbor (ARP) table:
...
4. From your host machine, scan the SSH port on your Arch VM through the forwarding rule:
