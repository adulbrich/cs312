...
Each distribution offers different desktop environments, so you can choose one that fits your preferences. You can easily try different distributions using live USBs or virtual machines. 
