...
<Aside type="caution" title="Before You Launch Anything">
- Use region **`us-east-1`**: `us-west-2` has caused permission issues for some students in the past.
- Click **⏹️ End Lab** at the end of every session. Resources left running consume your credit budget even when you are not actively working.
- Terminate EC2 and RDS instances when you are done with a lab. Stopped instances still incur storage charges; terminated instances do not.
- Credits update daily, not in real time. If you hit $50, your account is automatically deactivated and you cannot complete assignments.
</Aside>
...
If the page does not display, try another browser and enable cross-site tracking or allow all cookies. Check [Browser Support and Requirements | Vocareum - Documentation](https://help.vocareum.com/en/articles/6229305-browser-support-and-requirements).
</Aside>
