...
<Aside type="caution" title="Disclose AI Use">
...
<Aside type="note" title="Verify AI Output">
...
<Aside type="caution" title="Explain Before Submitting">
...
<Aside type="caution" title="Submission Readiness Rule">
